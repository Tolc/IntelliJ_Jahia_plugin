...
public interface CndTypes {
  ...
  IElementType PROPERTY_TYPE_MASK_OPTION = new CndElementType("PROPERTY_TYPE_MASK_OPTION");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == PROPERTY_TYPE_MASK_OPTION) {
        return new CndPropertyTypeMaskOptionImpl(node);
      }
