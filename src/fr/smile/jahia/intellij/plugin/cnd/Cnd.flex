...
NAMESPACE_START="<"{WHITE_SPACE}*
NAMESPACE_SEPARATOR={WHITE_SPACE}*"="{WHITE_SPACE}*"'"
...
NODE_TYPE_INHERITANCE_START={WHITE_SPACE}*">"{WHITE_SPACE}*
NODE_TYPE_INHERITANCE_ANOTHER={WHITE_SPACE}*","{WHITE_SPACE}*
NODE_TYPE_INHERITANCE_MIXIN={WHITE_SPACE}*"mixin"
NODE_TYPE_INHERITANCE_ORDERABLE={WHITE_SPACE}*"orderable"
NODE_TYPE_INHERITANCE_ABSTRACT={WHITE_SPACE}*"abstract"

PROPERTY_MINUS_START={WHITE_SPACE}*"-"{WHITE_SPACE}*
PROPERTY_PLUS_START={WHITE_SPACE}*"+"{WHITE_SPACE}*
PROPERTY_NAME_CHARS=[:jletter:][:jletterdigit:]*
PROPERTY_PLUS_NAME_CHARS={PROPERTY_NAME_CHARS}|"*"
PROPERTY_TYPE_START={WHITE_SPACE}+"("{WHITE_SPACE}*
PROPERTY_TYPE_END={WHITE_SPACE}*")"
...
PROPERTY_ATTRIBUTES=({WHITE_SPACE}+("mandatory"|"hidden"|"multiple"|"nofulltext"|"indexed=no"|"autocreated"|"boost="[:digit:]"."[:digit:]|"onconflict=sum"))+
PROPERTY_PLUS_ATTRIBUTES={WHITE_SPACE}+"autocreated"
...
EXTEND_START="extends"{WHITE_SPACE}*"="{WHITE_SPACE}*
EXTEND_ITEM_TYPE_START="itemtype"{WHITE_SPACE}*"="{WHITE_SPACE}*
...
//Namespaces "<snt = 'http://www.smile.fr/jahia/nt/1.0'>"
...
<NODE_TYPE_INHERITANCE_BEGIN> .                                             { yybegin(NODE_TYPE_INHERITANCE); return TokenType.BAD_CHARACTER; }
...
<PROPERTY_ADDENDUM> {PROPERTY_ATTRIBUTES}                  { yybegin(PROPERTY_ADDENDUM); return CndTypes.PROPERTY_ATTRIBUTES; }
...
<PROPERTY_PLUS_BEGIN> {PROPERTY_PLUS_NAME_CHARS}                    { yybegin(PROPERTY_PLUS_NAME_DONE); return CndTypes.PROPERTY_NAME; }
...
<PROPERTY_PLUS_ADDENDUM> {PROPERTY_PLUS_ATTRIBUTES}                 { yybegin(YYINITIAL); return CndTypes.PROPERTY_ATTRIBUTES; }
...
//<<EOF>>                         { return CndTypes.END_OF_FILE; }
